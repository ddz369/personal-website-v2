      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="relative">
            ...
            <div className="text-indigo-200 leading-relaxed space-y-4 relative">
              <p>
                From the prairies of{' '}
                <span className="text-indigo-300 font-medium">Saskatoon, SK</span>, I&apos;ve spent
                the last 7+ years of my life building{' '}
          ...
          <div className="bg-indigo-900/20 backdrop-blur-sm rounded-xl p-6 border border-indigo-800/30">
